...
export default function Home() {
  return (
    <div className="h-full px-6 md:px-10 flex justify-center">
      <div className="max-w-[1545px] w-full flex">
        <div className="h-full pt-64 xl:w-[50%]">
          <h1 className="text-4xl font-bold text-blue-600">📚 Create books summaries</h1>
          <p className="mt-6 text-5xl font-light max-w-[800px] leading-[1.4]">QuickSummary is a platform where you can <span className="bg-yellow-200 rounded-full px-4">create</span> summaries of your favorite books.</p>
        ...
        <div className="hidden xl:flex justify-center w-[50%] pt-32">
